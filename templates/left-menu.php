<section class="content__side">
        ...
        <ul class="main-navigation__list">
            <?php foreach($projects as $project): ?>
                <li class="main-navigation__list-item <?php if( isset($_GET['proj_id']) ):?><?php if( $_GET['proj_id'] == $project['id'] ):?>main-navigation__list-item--active<?php endif;?><?php endif;?>">
                    <a class="main-navigation__list-item-link" href="<?= $url."?proj_id=".htmlspecialchars($project['id']) ?>"><?= htmlspecialchars($project['name']); ?></a>
    ...
    <a class="button button--transparent button--plus content__side-button"
       href="/form-project" target="project_add">Добавить проект</a>
</section>
